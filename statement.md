...
- Create and update their placement profile.
- Manage their skills and proficiency levels.
- Add projects and certifications.
- Check placement readiness.
- Find matching companies and job roles.
- Identify missing skills for a selected job role.

### 2. Placement Administrators

Placement administrators can:

- View and search student profiles.
- Add, update, and remove companies.
- Add and manage job roles.
- View placement statistics.
- Generate student and company reports.

## High-Level Features

- Student profile management
- Skill and proficiency management
- Project management
- Certification management
- Placement readiness analysis
- Company and job role management
- Eligibility checking
- Company matching based on profile
- Skill gap analysis
